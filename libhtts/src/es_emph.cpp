...
======================== Contenido ========================
<DOC>
Metodos de {{LangES_Prosod}} que buscan los puntos de enfasis en los
...
PRIVATE CHAR *atonas[] =
{
	...
	NULL  // este NULL debe estar el ultimo!
};
...
VOID LangES_Prosod::utt_emphasis(UttPh & ut)
{
